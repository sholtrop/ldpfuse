...
static bool
cwk_path_get_first_segment_without_root(const char *path, const char *segments,
                                        struct cwk_segment *segment) {
...
static bool
cwk_path_get_last_segment_without_root(const char *path,
                                       struct cwk_segment *segment) {
...
static bool
cwk_path_get_previous_segment_joined(struct cwk_segment_joined *sj) {
  bool result;
...
static bool
cwk_path_segment_back_will_be_removed(struct cwk_segment_joined *sj) {
...
static bool
cwk_path_segment_normal_will_be_removed(struct cwk_segment_joined *sj) {
  enum cwk_segment_type type;
  int counter;
...
cwk_path_get_segment_type(const struct cwk_segment *segment) {
